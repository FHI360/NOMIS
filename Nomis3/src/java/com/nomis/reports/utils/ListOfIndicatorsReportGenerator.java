...
public class ListOfIndicatorsReportGenerator 
{
    public List getOvcEnrolledSummStatistics(ReportParameterTemplate rpt,String[] selectedIndicators) throws Exception
    {
        ...
        if(selectedIndicators !=null && selectedIndicators.length>0)
        {
            ...
            for(int i=0; i<selectedIndicators.length; i++)
            {
                ...
                //System.err.println("indicator.getIndicatorId() is "+indicator.getIndicatorId()+"; and indicator.getAutoGeneratedId() is "+indicator.getAutoGeneratedId()+"; indicator.getIndicatorName() is "+indicator.getIndicatorName());
                ...
                list.add(orm.getNoOfBeneficiariesNewlyEnrolledWithinReportPeriod(indicator,rpt, AppConstant.ACTIVE_GRADUATED_NUM));
                ...
                else if(rpt.getReportType()==AppConstant.CUSTOMINDICATORS_REPORTTYPE && indicator.getIndicatorSubtype() !=null && indicator.getIndicatorSubtype().equalsIgnoreCase(AppConstant.VULNERABILITYSTATUS_SUBTYPE))
                list.add(orm.getNoOfOvcByMainVulnerabilityType(rpt,rpt.getStartAge(), rpt.getEndAge(),indicator.getIndicatorId(),AppConstant.ACTIVE_NUM));
                ...
                list.add(orm.getNoOfOvcByOtherVulnerabilityTypes(rpt,rpt.getStartAge(), rpt.getEndAge(),indicator.getIndicatorId(),AppConstant.EVER_ENROLLED_NUM));
                ...
                */
                ...
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHIVPositiveCaregiversNewlyEnrolledOnARTWithinTheReportPeriod().getIndicatorId()))
                list.add(orm.getNumberOfAdultMembersEnrolledOnTreatment(indicator,rpt,AppConstant.ADULT_STARTAGE_NUM,AppConstant.ADULT_ENDAGE_NUM, rpt.getStartDate(), rpt.getEndDate(), AppConstant.EVER_ENROLLED_NUM));
                //getNumberOfAdultMembersEnrolledOnTreatment(Indicator indicator,ReportParameterTemplate rpt,int startAge,int endAge,String startDate,String endDate,int enrollmentStatus)
                ...
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcAssessedForHivRiskReferredForHivTestAndTestedPositiveWithinTheReportPeriod().getIndicatorId()))
                //list.add(orm.getNumberOfChildrenAssessedForHivRiskAndReferredForHivTestForTreatmentCascade(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,AppConstant.REFERRALCOMPLETED_YES_NUM,AppConstant.HIV_POSITIVE_NUM,AppConstant.ENROLLED_ON_TREATMENT_NOTAPPLICABLE));
                //list.add(orm.getNumberOfOvcAssessedForHivRiskTestedAndRecievedResultInReportPeriodByEnrollmentStatusAndHivStatus(indicator,rpt,AppConstant.EVER_ENROLLED_NUM,AppConstant.HIV_POSITIVE_NUM,AppConstant.ENROLLED_ON_TREATMENT_NOTAPPLICABLE));
                
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcNewlyTestedPositiveAndLinkedToTreatment().getIndicatorId()))
                //list.add(orm.getNumberOfChildrenAssessedForHivRiskAndReferredForHivTestForTreatmentCascade(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,AppConstant.REFERRALCOMPLETED_YES_NUM,AppConstant.HIV_POSITIVE_NUM,AppConstant.ENROLLED_ON_TREATMENT_YES_NUM));
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcAssessedForHivRiskReferredForHivTestTestedPositiveAndEnrolledOnARTWithinTheReportPeriod().getIndicatorId()))
                //list.add(orm.getNumberOfChildrenAssessedForHivRiskAndReferredForHivTestForTreatmentCascade(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,AppConstant.REFERRALCOMPLETED_YES_NUM,AppConstant.HIV_POSITIVE_NUM,AppConstant.ENROLLED_ON_TREATMENT_YES_NUM));
                    //list.add(orm.getNumberOfOvcAssessedForHivRiskTestedAndRecievedResultInReportPeriodByEnrollmentStatusAndHivStatus(indicator,rpt,AppConstant.EVER_ENROLLED_NUM,AppConstant.HIV_POSITIVE_NUM,AppConstant.ENROLLED_ON_TREATMENT_YES_NUM));
                ...
                list.add(orm.getOVC_ARTSUPPIndicator(indicator,rpt,rpt.getStartDate(),rpt.getEndDate(),AppConstant.EVER_ENROLLED_NUM));
                ...
                list.add(orm.getAdult_ARTSUPPIndicator(indicator,rpt,rpt.getStartDate(),rpt.getEndDate(),AppConstant.EVER_ENROLLED_NUM));
                ...
                else if(indicatorCode.equalsIgnoreCase(ind.getNoOfHivNegativeOvcAssessedForHIVRiskWithinReportPeriod().getIndicatorId()))
                list.add(orm.getNoOfOvcRiskAssessedByEnrollmentStatusAndHivStatus(indicator,rpt,rpt.getStartAge(),rpt.getEndAge(),rpt.getStartDate(),rpt.getEndDate(),AppConstant.ACTIVE_NUM,AppConstant.HIV_NEGATIVE_NUM));
                
                else if(indicatorCode.equalsIgnoreCase(ind.getNoOfHivUnknownOvcAssessedForHIVRiskWithinReportPeriod().getIndicatorId()))
                ...
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOVC_HIVSTATPOSITIVE().getIndicatorId()))
                list.add(orm.getNumberOfOVC_HIVSTATPOSITIVE(indicator,rpt));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOVC_HIVSTATNEGATIVE().getIndicatorId()))
                list.add(orm.getNumberOfOvc_HIVSTATNEGATIVE(indicator,rpt));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOVC_HIVSTATUNKNOWN().getIndicatorId()))
                list.add(orm.getNumberOfOvc_HIVSTATUNKNOWN(indicator,rpt));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOVC_HIVTestNotIndicated().getIndicatorId()))
                list.add(orm.getNumberOfOVC_HIVTestNotIndicated(indicator,rpt));
                ...
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcAssessedForHivRiskAndReferredForTesting().getIndicatorId()))
                //list.add(orm.getNumberOfOvcAssessedForHivRiskAndReferredForHivTest(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,false));
                    //list.add(orm.getNumberOfOvcAssessedForHivRiskAndReferredForHivRelatedTesting_HTSPMTCT(indicator,rpt,AppConstant.EVER_ENROLLED_NUM,AppConstant.HIV_POSITIVE_NUM,AppConstant.ENROLLED_ON_TREATMENT_YES_NUM));
                
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcAtRiskOfHivAndReferredForHivTest().getIndicatorId()))
                //list.add(orm.getNumberOfChildrenAssessedForHivRiskAndReferredForHivTestForTreatmentCascade(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,AppConstant.REFERRALCOMPLETED_NOT_APPLICABLE_NUM,AppConstant.HIV_ALL_STATUS_NUM,AppConstant.ENROLLED_ON_TREATMENT_NOTAPPLICABLE));
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcAtRiskOfHivAndReferredForHivTestAndCompletedReferral().getIndicatorId()))
                //list.add(orm.getNumberOfChildrenAssessedForHivRiskAndReferredForHivTestForTreatmentCascade(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,AppConstant.REFERRALCOMPLETED_YES_NUM,AppConstant.HIV_ALL_STATUS_NUM,AppConstant.ENROLLED_ON_TREATMENT_NOTAPPLICABLE));
                
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcAtRiskOfHivAndReferredForHivTestAndDidNotReceiveTest().getIndicatorId()))
                //list.add(orm.getNumberOfChildrenAssessedForHivRiskAndReferredForHivTestForTreatmentCascade(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,AppConstant.REFERRALCOMPLETED_NO_NUM,AppConstant.HIV_ALL_STATUS_NUM,AppConstant.ENROLLED_ON_TREATMENT_NOTAPPLICABLE));
                
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfBeneficiariesEligibleForViralLoad().getIndicatorId()))
                list.add(orm.getNumberOfBeneficiariesEligibleForViralLoad(indicator,rpt,rpt.getStartAge(),rpt.getEndAge(),AppConstant.CURRENTLY_ENROLLED_NUM,false));
                //getNumberOfOvcEnrolledOnTreatment(ReportParameterTemplate rpt,String startDate,String endDate,int enrolledOnTreatmentValue,int enrollmentStatus)
                ...
                list.add(orm.getNumberOfBeneficiariesEnrolledOnTreatment(indicator,rpt,null,null,AppConstant.ENROLLED_ON_TREATMENT_YES_NUM,AppConstant.ACTIVE_GRADUATED_NUM));
                //getBeneficiaryRecordsWithViralLoadResult(Indicator indicator,ReportParameterTemplate rpt,String startDate,String endDate,int enrolledOnTreatmentValue,int enrollmentStatus)
                ...
                list.add(orm.getBeneficiaryRecordsWithViralLoadResultInPast12Months(indicator,rpt,rpt.getStartDate(),rpt.getEndDate(),AppConstant.ACTIVE_GRADUATED_NUM));
                                
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHIVUnknownAndHivNegativeOvc().getIndicatorId()))
                list.add(orm.getNoOfOvcEnrolledByEnrollmentStatusAndHivStatus(indicator,rpt,AppConstant.ACTIVE_GRADUATED_NUM,AppConstant.HIV_UNKNOWN_NEGATIVE_NUM));
                
                //HIV Risk assessment cascade for custom indicators
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcEligibleForHIVRiskAssessment().getIndicatorId()))
                //list.add(orm.getNoOfOvcEligibleForHivRiskAssessment(indicator,rpt,1));
                //else if(indicatorCode.equalsIgnoreCase(ind.getNoOfOvcAssessedForHIVRiskWithinReportPeriod().getIndicatorId()))
                //list.add(orm.getNoOfOvcEligibleForHivRiskAssessmentThatWereRiskAssessed(indicator,rpt));
                //else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcAssessedForHivRiskAndDeterminedToBeAtRisk().getIndicatorId()))
                //list.add(orm.getNoOfEligibleOvcAssessedForHivRiskAndDeterminedToBeAtRisk(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM));
                
                
                //
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcWhoHadAChangeInRiskProfileSinceLastHivRisk().getIndicatorId()))
                list.add(orm.getNumberOfChildrenWithChangeInRiskProfile(indicator,rpt,1));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfOvcDocumetedAsReferredForHivTestOnRiskAssessmentForm().getIndicatorId()))
                list.add(orm.getNoOfOvcDocumentedOnHivRiskassessmentFormAsReferredForHIVTest(indicator,rpt,AppConstant.CHILD_AT_RISK_NUM,1));
                //else if(indicatorCode.equalsIgnoreCase(ind.getNoOfOvcAssessedForHIVRiskWithinReportPeriod().getIndicatorId()))
                //list.add(orm.getNoOfOvcRiskAssessedByEnrollmentStatusAndHivStatus(indicator,rpt,rpt.getStartAge(),rpt.getEndAge(),rpt.getStartDate(),rpt.getEndDate(),AppConstant.ACTIVE_GRADUATED_NUM,AppConstant.HIV_UNKNOWN_NEGATIVE_NUM));
                
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfBeneficiariesWhoAreVirallySuppresedInPast12Months().getIndicatorId()))
                list.add(orm.getBeneficiaryRecordsWhoAreVirallySuppressed(indicator,rpt,rpt.getStartDate(),rpt.getEndDate(),AppConstant.ACTIVE_GRADUATED_NUM));
                ...
                list.add(orm.getNumberOfActiveCaregiversServedForDatim(indicator,rpt,AppConstant.ADULT_STARTAGE_NUM,AppConstant.ADULT_ENDAGE_NUM));
                ...
                list.add(orm.getNumberOfGraduatedCaregiversServedForDatim(indicator,rpt,AppConstant.ADULT_STARTAGE_NUM,AppConstant.ADULT_ENDAGE_NUM));
                
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfActiveCaregivers18T024ServedWithinTheReportPeriodForDatim().getIndicatorId()))
                list.add(orm.getNumberOfActiveCaregiversServedForDatim(indicator,rpt,18,24));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfActiveCaregivers25PlusServedWithinTheReportPeriodForDatim().getIndicatorId()))
                list.add(orm.getNumberOfActiveCaregiversServedForDatim(indicator,rpt,25,AppConstant.ADULT_ENDAGE_NUM));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfGraduatedCaregivers18To24ServedWithinTheReportPeriodForDatim().getIndicatorId()))
                list.add(orm.getNumberOfGraduatedCaregiversServedForDatim(indicator,rpt,18,24));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfGraduatedCaregivers25PlusServedWithinTheReportPeriodForDatim().getIndicatorId()))
                list.add(orm.getNumberOfGraduatedCaregiversServedForDatim(indicator,rpt,25,AppConstant.ADULT_ENDAGE_NUM));
                
                
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHouseholdsThatCanSolveEmergencyNeedsWithinReportingPeriod().getIndicatorId()))
                list.add(orm.getNumberOfHouseholdsThatAccessFundToMeetUnexpectedExpences(indicator,rpt,AppConstant.EVER_ENROLLED_NUM));
                
                //
                else if(indicatorCode.equalsIgnoreCase("hhcasepland"))
                {
                    rpt.setStartAge(AppConstant.ADULT_STARTAGE_NUM);
                    rpt.setEndAge(AppConstant.ADULT_ENDAGE_NUM);
                ...
                list.add(orm.getOVC_SERV(rpt,AppConstant.ALL_SERVICE_DOMAIN,null,null));
                /*else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfSurvivorsOfViolenceAgainstChildrenServedMer().getIndicatorId()))
                list.add(orm.getOVC_SERV(rpt));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfAdolescentsAtHighRiskOfHIVServedMER().getIndicatorId()))
                list.add(orm.getOVC_SERV(rpt));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfChildrenLivingWithHivServedMer().getIndicatorId()))
                list.add(orm.getOVC_SERV(rpt));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfChildrenLivingWithPLHIVServedMer().getIndicatorId()))
                list.add(orm.getOVC_SERV(rpt));
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfChildrenOfKeyPopServedMer().getIndicatorId()))
                list.add(orm.getOVC_SERV(rpt));*/
                
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHIVExposedInfantsServedMer().getIndicatorId()))
                list.add(orm.getOVC_SERVByEnrollmentStatusAndEnrollmentStream(rpt,AppConstant.ACTIVE_NUM,rpt.getStartDate(),rpt.getEndDate(),rpt.getStartAge(),rpt.getEndAge(),indicator.getAutoGeneratedId()));
                ...
                list.add(orm.getOVC_SERV(rpt,AppConstant.ALL_SERVICE_DOMAIN,null,null));
                else if(indicatorCode.equalsIgnoreCase(ind.getNoOfOvcServedWithinTheReportPeriodThatHasBirthCert().getIndicatorId()))
                list.add(orm.getOVC_SERV(rpt,AppConstant.HEALTH_DOMAIN,OvcServiceAttributesManager.getBirthRegistrationAcquisitionService().getServiceCode(),null));
            }
    ...
    public List getOvcList(ReportParameterTemplate rpt,String sex,String indicatorCode) throws Exception
    {
        ...
        List mainList=new ArrayList();
            ...
            OvcReportManager orm=new OvcReportManager();
            //boolean numberOfServicesSet=false;
            int startAge=rpt.getStartAge();
            int endAge=rpt.getEndAge();
            String orgUnitQuery=rsg.getOrganizationUnitQuery(rpt);
            String ageQuery=rsg.getOvcCurrentAgeQuery(rpt.getStartAge(),rpt.getEndAge());
            String ovcServiceAgeQuery=rsg.getAgeAtOvcServiceQuery(rpt.getStartAge(),rpt.getEndAge());
            String additionalQueryCriteria=orgUnitQuery;
            ...
            //getListOfOvcEnrolledByEnrollmentStatus(String additionalQueryCriteria,String ageQuery,String sex,int enrollmentStatus)
                ...
                list=orm.getListOfOvcByOtherVulnerabilityTypes(rpt,rpt.getStartAge(), rpt.getEndAge(),sex,indicator.getIndicatorId(),AppConstant.EVER_ENROLLED_NUM);
                ...
                */
                ...
                list=orm.getListOfOvcEnrolledOnTreatment(rpt,startAge,endAge,null, null, AppConstant.ENROLLED_ON_TREATMENT_YES_NUM,AppConstant.ACTIVE_NUM,sex);
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHivPositiveNotOnTreatment().getIndicatorId()))
                //startdate and enddate are not required for tracking positives not on treatment, so they are set to null
                list=orm.getListOfOvcEnrolledOnTreatment(rpt,startAge,endAge,null, null, AppConstant.ENROLLED_ON_TREATMENT_NO_NUM,AppConstant.ACTIVE_NUM,sex);
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHivPositiveEnrolledOnTreatmentInReportPeriod().getIndicatorId()))
                list=orm.getListOfOvcEnrolledOnTreatment(rpt,startAge,endAge,rpt.getStartDate(), rpt.getEndDate(), AppConstant.ENROLLED_ON_TREATMENT_YES_NUM,AppConstant.ACTIVE_NUM,sex);
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHivPositiveOvcEnrolledOnARTWithinTheReportPeriod().getIndicatorId()))
                list=orm.getListOfOvcEnrolledOnTreatment(rpt,startAge,endAge,rpt.getStartDate(), rpt.getEndDate(), AppConstant.ENROLLED_ON_TREATMENT_YES_NUM,AppConstant.EVER_ENROLLED_NUM,sex);
                
                else if(indicatorCode.equalsIgnoreCase(ind.getIndicatorForNumberOfHIVPositiveCaregiversNewlyEnrolledOnARTWithinTheReportPeriod().getIndicatorId()))
                list=orm.getListOfAdultMembersEnrolledOnTreatment(rpt,AppConstant.ADULT_STARTAGE_NUM,AppConstant.ADULT_ENDAGE_NUM, rpt.getStartDate(), rpt.getEndDate(),AppConstant.EVER_ENROLLED_NUM,sex);
                ...
                */
                ...
                list=orm.getListOfHouseholdsThatAccessFundToMeetUnexpectedExpences(indicator,rpt,AppConstant.EVER_ENROLLED_NUM,sex);
