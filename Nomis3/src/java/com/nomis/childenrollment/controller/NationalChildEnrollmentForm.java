 ...
 * @author smomoh
 */
public class NationalChildEnrollmentForm extends org.apache.struts.action.ActionForm {
...
//private String nearestFacilityId;
...
private int beneficiaryType;
    public NationalChildEnrollmentForm() {
        super();
...
public void reset(ActionMapping mapping, HttpServletRequest request)
{
    ...
    foodSecurity=0;
wellness=0;
nutritionAndGrowth=0;
healthCareServices=0;
shelter=0;
emotionalHealth=0;
care=0;
socialBehaviour=0;
abuseAndExploitation=0;
developmentAndPerformance=0;
legalProtection=0;
educationAndWork=0;
}
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        else if(dbDateOfEnrollment !=null )
        {
            ...
            else if(this.getHhUniqueId()==null || this.getHhUniqueId().trim().length()==0)
            ...
            else if(this.getBaselineHivStatus()==1)
            {
                if(this.getChildEnrolledOnTreatment()==0)
                errors.add("childEnrolledOnTreatment", new ActionMessage("errors.childEnrolledOnTreatment.required"));
                else if(this.getFacilityId()==null || this.getFacilityId().trim().equalsIgnoreCase("select"))
                errors.add("facilityId", new ActionMessage("errors.facilityId.required"));
            }*/
            ...
            else if(this.getCaregiverId()==null || this.getCaregiverId().trim().equalsIgnoreCase("select"))
            ...
            errors.add("volunteerName", new ActionMessage("errors.enumeratorName.required"));
