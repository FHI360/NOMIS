...
private ProgressIndicator getProgressIndicator(ProgressIndicator progressIndicator,String taskName,int totalNumberOfRecords,int numberSaved,int numberUpdated,int completeFlag)
{
    ...
    if(completeFlag>0)
    progressIndicator.setProcessStartFlag(1);
    progressIndicator.setProcessEndFlag(completeFlag);
    if(progressIndicator.getProcessEndFlag()==1)
    progressIndicator.setStatusMessage("Complete");
    else
    progressIndicator.setStatusMessage("Processing...");
    ...
    try
	{
		...
		String fileName=filePath+exportFileName+".xml";
                ...
                if(files !=null)
                {
                    ...
                    ProgressIndicator progressIndicator=getProgressIndicator(null,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0);
                    //progressIndicator.setTotalSize(totalNumberOfRecords);
                    //progressIndicator.setTaskName(taskName);
                            ...
                            Node firstNode = listOfObjects.item(s);
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {
                                ...
                                if(hhe.getHhUniqueId() !=null && hhe.getHhUniqueId().indexOf("/") !=-1 && hhe.getDateOfAssessment() !=null)    
                                {
                                    ...
                                    dataImportIndicator.setHouseholdEnrollmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
...
public List importHouseholdVulnerabilityAssessmentRecordsFromXML(String destinationDirectory,int hheOption)
{
    ...
    String tagName="HouseholdAssessment";
    String taskName="Household Vulnerability Assessment";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                             ...
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {
                                ...
                                if(existingHva==null)
                                {
                                    ...
                                    //{
                                        ...
                                        numberSaved++;
                                        //progressIndicator.setUpdatedRecordsSize(numberSaved);
                                ...
                                dataImportIndicator.setHouseholdAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                             
                        }
                    }
                    dataImportIndicator.setHouseholdAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importRevisedHouseholdVulnerabilityAssessmentRecordsFromXML(String destinationDirectory,int hheOption)
{
    ...
    String tagName="HouseholdAssessment";
    String taskName="Revised Household Vulnerability Assessment";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {
                               ...
                               dataImportIndicator.setRevisedHouseholdAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                               AppUtility.setDataImportIndicator(dataImportIndicator); 
                             }
                        }
                    }
                    dataImportIndicator.setRevisedHouseholdAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importAdultHouseholdMembersRecordsFromXML(String destinationDirectory,int hheOption)
{
    ...
    String tagName="AdultHouseholdMember";
    String taskName="Adult Household Members enrollment";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {
                                ...
                                dataImportIndicator.setAdultHouseholdMembersEnrollmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setAdultHouseholdMembersEnrollmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importOvcRecordsFromXML(String destinationDirectory,int ovcOption)
{
    ...
    String tagName="ovc";
    String taskName="Child enrollment";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {
                                ...
                                ovc.setHivTreatmentFacilityId(getNodeValue("hivTreatmentFacility",s,listOfObjects));
                                if(getNodeName("mainVulnerabilityStatusCode",s,listOfObjects) !=null)
                                ovc.setMainVulnerabilityStatusCode(getNodeValue("mainVulnerabilityStatusCode",s,listOfObjects));
                                ovc.setVulnerabilityStatusCode(getNodeValue("vulnerabilityStatusCode",s,listOfObjects));
                                ...
                                if(getNodeName("enrollmentSetting", s, listOfObjects) !=null)
                                ovc.setEnrollmentSetting(getIntegerNodeValue(getNodeValue("enrollmentSetting",s,listOfObjects)));
                                ...
                                ovc.setAgeUnitAtBaseline(AppConstant.AGEUNIT_YEAR_NUM);
                                ...
                                dataImportIndicator.setChildEnrollmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                  dataImportIndicator.setChildEnrollmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                  AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importFacilityOvcOfferRecordsFromXML(String destinationDirectory)
{
    AppUtility appUtil=new AppUtility();
    List list=new ArrayList();
    String fileSeperator=appUtil.getFileSeperator();
    String exportFileName="FacilityOvcOffer";
    String tagName="facilityEnrollment";
    String taskName="Facility OVC Offer";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
    List duplicateRecordsList=new ArrayList();
    newRecordsList.add("Number of new Facility OVC Offer records saved");
    duplicateRecordsList.add("Number of Facility OVC Offer records saved as updates");
    int numberSaved=0;
    int numberUpdated=0;
    int count=0;
    ...
    try
	{
		...
		String fileName=filePath+exportFileName+".xml";
                ...
                if(files !=null)
                {
                    ...
                    FacilityOvcOffer existingFoo=null;
                    ProgressIndicator progressIndicator=getProgressIndicator(null,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0);
                    ...
                    for(int i=0; i<files.size(); i++)
                    {
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            foo=new FacilityOvcOffer();
                            Node firstNode = listOfObjects.item(s);
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {
                                String clientUniqueId=getNodeValue("clientUniqueId",s,listOfObjects);
                                foo.setClientUniqueId(clientUniqueId);
                                foo.setLevel4OuId(getNodeValue("level4OuId",s,listOfObjects));
                                foo.setTreatmentId(getNodeValue("treatmentId",s,listOfObjects));
                                foo.setClientFirstName(getNodeValue("clientFirstName",s,listOfObjects));
                                foo.setClientSurname(getNodeValue("clientSurname",s,listOfObjects));
                                
                                foo.setHivTreatmentFacilityId(getNodeValue("hivTreatmentFacilityId",s,listOfObjects));
                                foo.setAge(getIntegerNodeValue(getNodeValue("age",s,listOfObjects)));
                                foo.setAgeUnit(getIntegerNodeValue(getNodeValue("ageUnit",s,listOfObjects)));
                                foo.setSex(getNodeValue("sex",s,listOfObjects));
                                foo.setNameOfPersonToShareContactWith(getNodeValue("nameOfPersonToShareContactWith",s,listOfObjects));
                                foo.setDateEnrolledOnTreatment(DateManager.getDateInstance(getNodeValue("dateEnrolledOnTreatment",s,listOfObjects)));
                                foo.setShareContactQuestion(getIntegerNodeValue(getNodeValue("shareContactQuestion",s,listOfObjects)));
                                foo.setCaregiverFirstName(getNodeValue("caregiverFirstName",s,listOfObjects));
                                foo.setCaregiverSurname(getNodeValue("caregiverSurname",s,listOfObjects));
                                foo.setDateCaregiverSigned(DateManager.getDateInstance(getNodeValue("dateCaregiverSigned",s,listOfObjects)));
                                foo.setFacilityStaffFirstName(getNodeValue("facilityStaffFirstName",s,listOfObjects));
                                foo.setFacilityStaffSurname(getNodeValue("facilityStaffSurname",s,listOfObjects));
                                foo.setDateFacilityStaffSigned(DateManager.getDateInstance(getNodeValue("dateFacilityStaffSigned",s,listOfObjects)));
                                
                                foo.setLastModifiedDate(DateManager.getDateInstance(getNodeValue("lastModifiedDate",s,listOfObjects)));
                                foo.setCboId(getNodeValue("cboId",s,listOfObjects));
                                foo.setPartnerCode(getNodeValue("partnerCode",s,listOfObjects));
                                foo.setMarkedForDelete(getIntegerNodeValue(getNodeValue("markedForDelete",s,listOfObjects)));
                                foo.setUserName(getNodeValue("userName",s,listOfObjects));
                                
                                
                                existingFoo=dao.getFacilityOvcOffer(clientUniqueId);
                                if(existingFoo==null)
                                {
                                        count++;
                                        dao.saveFacilityOvcOffer(foo);
                                        numberSaved++;
                                        System.err.println("FacilityOvcOffer record: "+count+" saved");
                                        AppUtility.setCurrentImportRecordName("FacilityOvcOffer record: "+count+" saved");
                                }
                                else
                                {
                                    if(existingFoo.getLastModifiedDate().before(foo.getLastModifiedDate()) || existingFoo.getLastModifiedDate().equals(foo.getLastModifiedDate()))
                                    {
                                        count++;
                                        dao.updateFacilityOvcOffer(foo);
                                        numberUpdated++;
                                        System.err.println("FacilityOvcOffer record: "+count+" updated");
                                        AppUtility.setCurrentImportRecordName("FacilityOvcOffer record: "+count+" saved");
                                    }
                                }
                                dataImportIndicator.setFacilityOvcOfferIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                  dataImportIndicator.setFacilityOvcOfferIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                  AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importOvcServiceRecordsFromXML(String destinationDirectory,int saveOption)//HouseholdService
{
    ...
    String tagName="ChildService";
    String taskName="Child services";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
    ...
    try
	{
		...
		String fileName=filePath+exportFileName+".xml";
                ...
                if(files !=null)
                {
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {
                                ...
                                dataImportIndicator.setChildServiceIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                    ...
                    dataImportIndicator.setChildServiceIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importHouseholdServiceRecordsFromXML(String destinationDirectory,int saveOption)
{
    ...
    String tagName="HouseholdService";
    String taskName="Household service";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
    ...
    try
	{
		...
		String fileName=filePath+exportFileName+".xml";
                ...
                if(files !=null)
                {
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {                          
                                ...
                                dataImportIndicator.setHouseholdServiceIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                    ...
                    dataImportIndicator.setHouseholdServiceIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importHivRiskAssessmentRecordsFromXML(String destinationDirectory,int saveOption)
{
    ...
    String tagName="HivRiskAssessment";
    String taskName="Hiv Risk assessment records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {  
                                ...
                                dataImportIndicator.setHivRiskAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setHivRiskAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importNutritionAssessmentFromXml(String destinationDirectory)
    ...
    String tagName="NutritionAssessment";
    String taskName="NutritionAssessments records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                    ...
                    for(int s=0; s<listOfObjects.getLength() ; s++)
                    {
                        ...
                        Node firstNode = listOfObjects.item(s);
                         if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                         {
                            ...
                            dataImportIndicator.setNutritionAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                            AppUtility.setDataImportIndicator(dataImportIndicator);
                         }
                    }
                        t++;
                    }
                    dataImportIndicator.setNutritionAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
                    newRecordsList.add(numberSaved);
                    duplicateRecordsList.add(numberUpdated);
            }
...
public List importReferralRecordsFromXML(String destinationDirectory)
{
    ...
    String tagName="ReferralService";
    String taskName="Referral Service records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {  
                                ...
                                dataImportIndicator.setHouseholdReferralIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setHouseholdReferralIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importCareAndSupportRecordsFromXML(String destinationDirectory)
{
    ...
    String tagName="CareAndSupportAssessment";
    String taskName="Referral Service records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    ...
    try
	{
		...
		String fileName=filePath+exportFileName+".xml";
                ...
                if(files !=null)
                {
                    ...
                    ProgressIndicator progressIndicator=getProgressIndicator(null,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0);
                    String viralLoadTestDone=null;
                    String dateOfViralLoadTest=null;
                    String viralLoadResult=null;
                    String dateOfViralLoadResult=null;
                    for(int i=0; i<files.size(); i++)
                    {
                        //System.err.println(filePath+files.get(i).toString());
                        fileName=filePath+files.get(i).toString();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             if(firstNode.getNodeType() == Node.ELEMENT_NODE)
                             {  
                                viralLoadTestDone=getNodeValue("viralLoadTestDone",s,listOfObjects);
                                dateOfViralLoadTest=getNodeValue("dateOfViralLoadTest",s,listOfObjects);
                                viralLoadResult=getNodeValue("viralLoadResult",s,listOfObjects);
                                if(getNodeName("dateOfViralLoadResult",s,listOfObjects) !=null)
                                dateOfViralLoadResult=getNodeValue("dateOfViralLoadResult",s,listOfObjects);
                                ...
                                /*if(viralLoadTestDone !=null && viralLoadTestDone.indexOf("-") !=-1)
                                {
                                    if(dateOfViralLoadTest==null || dateOfViralLoadTest.indexOf("-")==-1)
                                    {
                                        casc.setDateOfViralLoadSampleCollection(DateManager.getDateInstance(viralLoadTestDone));
                                        if(dateOfViralLoadTest !=null && !dateOfViralLoadTest.equalsIgnoreCase("none"))
                                        casc.setViralLoadTestDone(Integer.parseInt(dateOfViralLoadTest));
                                    }
                                }
                                if(viralLoadResult !=null && viralLoadResult.indexOf("-") !=-1)
                                {
                                   if(dateOfViralLoadResult==null || dateOfViralLoadResult.indexOf("-")==-1)
                                   {
                                       casc.setDateOfViralLoadResult(DateManager.getDateInstance(viralLoadResult));
                                       if(dateOfViralLoadResult !=null && dateOfViralLoadResult.equalsIgnoreCase("none"))
                                       casc.setViralLoadResult(Integer.parseInt(dateOfViralLoadResult));
                                   }
                                }*/
                                ...
                                dataImportIndicator.setCareAndSupportIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setCareAndSupportIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importCaregiverAccessToEmergencyFundRecordsFromXML(String destinationDirectory)
{
    ...
    //String exportFileName="RevisedHouseholdVulnerabilityAssessments";
    String tagName="Assessment";
    String taskName="Caregiver access to emergency fund records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {  
                                ...
                                dataImportIndicator.setCaregiverAccessToEmergencyFundIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setCaregiverAccessToEmergencyFundIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importCareplanAchievementChecklistRecordsFromXML(String destinationDirectory)
{
    ...
    String tagName="Assessment";
    String taskName="Careplan achievement checklist records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {  
                                ...
                                dataImportIndicator.setCareplanAchievementIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setCareplanAchievementIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importChildEducationPerformanceAssessmentRecordsFromXML(String destinationDirectory)
{
    ...
    String tagName="Assessment";
    String taskName="Child education performance assessment records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {  
                                ...
                                dataImportIndicator.setChildEducationalAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setChildEducationalAssessmentIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
	}
...
public List importBeneficiaryStatusUpdateRecordsFromXML(String destinationDirectory)
{
    ...
    String tagName="BeneficiaryStatusUpdate";
    String taskName="Beneficiary status update records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {  
                                ...
                                dataImportIndicator.setStatusUpdateIndicatorIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setStatusUpdateIndicatorIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
...
public List importHouseholdCareplanRecordsFromXML(String destinationDirectory)
{
    ...
    String tagName="careplan";
    String taskName="Household Care plan records";
    String filePath=destinationDirectory+fileSeperator+exportFileName+fileSeperator;
    int totalNumberOfRecords=getTotalNumberOfRecordsFromXML(filePath,tagName);
    AppUtility.setCurrentImportRecordName(taskName);
    List newRecordsList=new ArrayList();
                        ...
                        for(int s=0; s<listOfObjects.getLength() ; s++)
                        {
                            ...
                            Node firstNode = listOfObjects.item(s);
                             ...
                             {  
                                ...
                                dataImportIndicator.setHouseholdCareplanIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,0));
                                AppUtility.setDataImportIndicator(dataImportIndicator);
                             }
                        }
                    }
                    dataImportIndicator.setHouseholdCareplanIndicator(getProgressIndicator(progressIndicator,taskName,totalNumberOfRecords,numberSaved,numberUpdated,1));
                    AppUtility.setDataImportIndicator(dataImportIndicator);
	        }
             newRecordsList.add(numberSaved);
            duplicateRecordsList.add(numberUpdated);       
                ...
                for(int i=0; i<uploadedFileList.size(); i++)
                {
                    ...
                    if(fileName !=null)
                    {
                        ...
                        if(isNomis3File(destinationDirectory))
                        {
                            ...
                            mainList.addAll(importFacilityOvcOfferRecordsFromXML(destinationDirectory));
